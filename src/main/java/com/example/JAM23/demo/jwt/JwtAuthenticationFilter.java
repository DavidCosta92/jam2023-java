...
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter { // OncePerRequestFilter es para que el filtro se ejecute cada vez por cada solicitud http
